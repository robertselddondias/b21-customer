...
class ReferralScreen extends StatelessWidget {
  ...
  Future<void> share(ReferralController controller) async {
    ...
    // await Share.share(
    //   'Olá, obrigado por escolher a B-21. Espero que você ame nosso produto. Se gostar, compartilhe com seus amigos usando o código ${controller.referralModel.value.referralCode.toString()} e obtenha ${Constant.amountShow(amount: Constant.referralAmount)}.'.tr,
    // );
  }
}
